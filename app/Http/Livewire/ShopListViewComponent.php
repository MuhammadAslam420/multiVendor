...
class ShopListViewComponent extends Component
{
    public $sorting;
    public $pagesize;
    public $min_price;
    ...
    public function render()
    {
        ...
        return view('livewire.shop-list-view-component',['products'=>$products,'categories'=>$categories,'sale'=>$sale,
        'new'=>$new,'deals'=>$deals])->layout('layouts.base');
    }
}
