                ...
                <div class="product-list mb-50">
                    ...
                    <div class="product-cart-wrap">
                        ...
                        <div class="product-content-wrap">
                            ...
                            <p class="mt-15 mb-15">{!! $product->short_description !!}</p>
                            ...
                            <div class="mt-30 d-flex align-items-center">
                                ...
                                <a href="#"
                                    class="add-wishlish ml-30 text-body font-sm font-heading font-weight-bold" wire:click.prevent="addToCompare({{$product->id}},'{{$product->name}}',{{$product->price}})"><i
                                        class="fa fa-random mr-5"></i>Add Compare</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
