                        ...
                        <div class="vendor-content-wrap">
                            <div class="mb-30">
                                ...
                                <div class="vendor-info d-flex justify-content-between align-items-end mt-30">
                                    ...
                                    <a href="{{ route('vendors-stores',['id'=>$vendor->user->id]) }}" class="btn btn-xs"> <i class="fa fa-arrow-right " style="padding-top:7px;padding-right:5px;"></i> Visit Store</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="vendor-img-action-wrap">
                            <div class="vendor-img">
                                <a href="vendor-details-1.html">
                                    <img class="default-img" src="{{ asset('assets/images/no-records.png') }}" alt="" />
                                </a>
                            </div>

                        </div>
                        <div class="vendor-content-wrap">
                           <h3 class="text-center text-danger">Sorry currently  no vendors available</h3>
                        </div>
                    </div>
                </div>
                @endforelse
