        ...
        <div class="row">
            <div class="col-lg-7">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6">
                            <input type="text"  name="email" placeholder="Email *" wire:model="email">
                        </div>
                        <div class="form-group col-lg-6">
                            <input type="text"  name="mobile" placeholder="Mobile *" wire:model="mobile">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-6">
                            <input type="text" name="line1"  placeholder="line1 address*" wire:model="line1">
                        </div>
                        <div class="form-group col-lg-6">
                            <input type="text" name="line2"  placeholder="Address line2" wire:model="line2">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6">
                            <input  type="text" name="state" placeholder="state *" wire:model="province">
                        </div>
                    </div>
                    <div class="custome-checkbox">
                        <input name="different-add" id="different-add" value="1" type="checkbox" wire:model="ship_to_different">
                        <label class="form-label label_info"><span>Ship to a different address?</span></label>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-6">
                                <input type="text"  name="email" placeholder="Email *" wire:model="s_email">
                            </div>
                            <div class="form-group col-lg-6">
                                <input type="text"  name="mobile" placeholder="Mobile *" wire:model="s_mobile">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-6">
                                <input type="text" name="line1"  placeholder="line1 address*" wire:model="s_line1">
                            </div>
                            <div class="form-group col-lg-6">
                                <input type="text" name="line2"  placeholder="Address line2" wire:model="s_line2">
                            </div>
                        </div>
                        <div class="row shipping_calculator">
                            <div class="form-group col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <input  type="text" name="state" placeholder="state *" wire:model="s_province">
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="table-responsive order_table checkout">
                        <table class="table no-border">
                          ...
                          <tbody>
                            <tr>
                                <td>subtotal</td>
                                <td>{{Session::get('checkout')['subtotal']}}
                                </td>
                            </tr>
                            <tr>
                                <td >Shipping Charges</td>
                                <td>
                                   {{(Session::get('checkout')['total']) - (Session::get('checkout')['subtotal'] + Session::get('checkout')['tax'])}}
                                </td>
                            </tr>
                            <tr>
                                <td>Grand Total</td>
                ...
                <div class="payment ml-30">
                    ...
                    <div class="payment_option">
                        ...
                        <div class="custome-radio mt-5">
                            <input  type="radio" name="payment-method" id="payment-method-visa" value="card" wire:model="paymentmode">
                    ...
                    <div class="payment-logo d-flex">
                        <img class="mr-15" src="{{asset('assets/images/payment-paypal.svg')}}" alt="">
                    ...
                    <button type="submit"  class="btn btn-fill-out btn-block mt-30">Place an Order<i class="fa fa-sign-out ml-15"></i></button>
                </div>
            </div>
        </div>
       </form>
